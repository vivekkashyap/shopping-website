  ...
  <body class="w3-content" style="max-width:1200px">
    <div>
      ...
      <hr>
        ...
        <p>Name <input type="text" class="w3-select w3-border" name="pname" value=""/></p>
...
<?php	
  ...
  $pname = '';
    ...
    $category = isset($_POST['category']) ? $_POST['category'] : '';
		...
		$source = $_FILES['source']['pname'];
		$tempname = $_FILES['source']['tmp_name'];
		$folder = "img/".$source;
		move_uploaded_file($tempname, $folder);
	}
 
	if ($category!="" && $pname!="" && $oldamount!="" && $newamount!="" && $source!="")
	{
		$query = "INSERT INTO product VALUES ('','$category','$pname','$oldamount','$newamount','$folder','')" ;
